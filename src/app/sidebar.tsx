const SideBar = () => {
    return (
        <div
            className={'fixed top-0 left-0 h-screen w-16 m-0 p-0 flex flex-col bg-[var(--japanese-indigo)] border-solid border-l-0 border-t-0 border-b-0 border-r-2 border-[var(--cadet-grey)] rounded-r'}>
            <div className={'mb-auto pl-0.5 pt-2 grid grid-rows-2 grid-flow-col gap-0'}>
                ...
                <span className={'italic font-bold font-mono text-[var(--cadet-grey)] tracking-tighter'}>ose</span>
